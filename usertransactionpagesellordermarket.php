...
<head>
	...
	<script src="UniversalAssets/js/escrowsellorderarea.js"></script>	
...
<body onload = "valueselldisplay()" >

			<div class="card-body">
			  <h5 class="card-title" id="buy" style="color:red;"><i class="fa fa-minus-circle" aria-hidden="true" style="margin-right:10px; color:red;"></i>SELL</h5>
			  <div class="right-logo">
				<h3>Solar<span><</span>><span>Share</span></h3>
			  </div>			  
				<form id="buydash" autocomplete="off" action="transactiondatatodb.php" method="post">
				  <div class="form-group row">
					<label for="electroamounttext" class="col-xs-4 col-sm-6 col-md-4 col-form-label-sm">Amount:</label>
					<div class="col-xs-8 col-sm-6 col-md-8">
					  <input id="displaybuy1" type="text" name="amount" class="form-control form-control-sm" placeholder="" readonly>
					</div>
				  </div>
				  ...
				  <div class="form-group row">
					...
					<div class="col-xs-8 col-sm-6 col-md-8">
					  <input id="displaybuy2" type="text" name="price" class="form-control form-control-sm" placeholder="" readonly>
					</div>
				  </div>
				  ...
				  <div class="form-group row">
					...
					<div class="col-xs-8 col-sm-6 col-md-8">
					  <input id="displaybuy3" type="text" name="total" class="form-control form-control-sm" placeholder="" readonly>
					</div>
				  </div>
				  ...
				  <div class="form-group row">
					<div class="col-sm-10">
					  <a class="btn btn-transaction" id="giveticket" name="transactionbtn" onclick="escrowtransactionbuyenergy(); notification();">SELL ENERGY</a>
